-- Fix created_by columns to TEXT type by dropping all policies first
...
-- Drop ALL policies on animations
DO $$ 
DECLARE
    r RECORD;
BEGIN
...
-- Re-add policies for public read and service role bypass
